...
const Header = ({ actions, userName, authorized, filterTrack, history }) => {
  ...
  const handleSearch = e => {
    actions.searchTest(e.target.value);
  ...
  return (
    <div className="header">
      ...
      <div className="header--right">
        {authorized && <div className="search-box">
          <svg
        ...
        {authorized && <div className="filter-box" onClick={handleSort}>
...
// let ne = [
//   '2020-01-10T14:59:12.871Z',
//   '2020-01-10T14:59:14.479Z',
//   '2020-01-10T14:59:10.937Z',
// ]

// let x = ne.sort(function(a, b){
//     var dateA=new Date(a.retiredate), dateB=new Date(b.retiredate)
//     return dateA-dateB //сортировка по возрастающей дате
//     })
